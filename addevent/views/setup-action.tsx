...
export class SetupAction {
  ...
  @State() fields = [{"type":"text","label":"Client ID","controlName":"clientID"},{"type":"password","label":"Client Secret","controlName":"clientSecret"},{"type":"password","label":"Api Key","controlName":"apiKey"}]
